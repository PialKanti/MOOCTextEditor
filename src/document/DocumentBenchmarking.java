	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for(int i = 1; i<= trials; i++){
				Document document = new BasicDocument(stringFromFile);
			...
			for(int i = 1; i<= trials; i++){
				Document document = new EfficientDocument(stringFromFile);
				document.getFleschScore();
			}
			
			long EndTimeEfficientDoc = System.nanoTime();
			double estTimeEfficientDoc = (EndTimeEfficientDoc - startTimeEfficientDoc)/1000000000.0;
			
			System.out.print(estTimeEfficientDoc + "\n");
